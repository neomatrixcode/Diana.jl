...
""")
        ...
        s=string(e)
        @test s == "ErrorException(\"{\\\"errors\\\":[{\\\"locations\\\": [{\\\"column\\\": 27,\\\"line\\\": 6}],\\\"message\\\": \\\"Syntax Error GraphQL request (27:6) Expected NAME, found } \\\"}]}\")"
      end
